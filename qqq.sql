/*
Original MySQL reference schema for the Electronic Asset Trading Platform.
The current application runs on LocalDataStore and does not require MySQL.
*/
...
insert into `storage`(`id`,`storagename`,`storagestyle`,`storageID`,`seller`) values
  (12,'blue','aa','400','d'),
  (13,'343','32325','325','java'),
  (14,'milk','caw','400','java'),
  (16,'rtrt','fefe','200','d');
...
insert into `users`(`id`,`username`,`userpwd`,`integrate`,`flag`) values
  (1,'admin','123456','1000',2),
  (2,'java','1','8600',1),
  (4,'d','123','300',1);
